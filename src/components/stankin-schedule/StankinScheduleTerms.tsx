    ...
    return (
        <ContentBox>
            ...
            <Typography paragraph>
                ...
                property rights related to it, still belong to Nikolay Vereshchagin.
            </Typography>

            <Typography paragraph>
                Nikolay Vereshchagin is committed to ensuring that the app is as useful and efficient as possible.
            ...
            <Typography paragraph>
                The Stankin Schedule app stores and processes personal data that you have provided to us,
                ...
                It could make your phone vulnerable to malware/viruses/malicious programs, compromise
                your phone’s security features and it could mean that the Stankin Schedule app won’t work properly or at all.
            </Typography>
            ...
            <Typography paragraph>
                You should be aware that there are certain things that Nikolay Vereshchagin will not take responsibility for.
                Certain functions of the app will require the app to have an active internet connection.
                The connection can be Wi-Fi, or provided by your mobile network provider, but Nikolay Vereshchagin
                cannot take responsibility for the app not working at full functionality if
            ...
            <Typography paragraph>
                ...
                that your terms of the agreement with your mobile network provider will still apply.
                As a result, you may be charged by your mobile provider for the cost of data for
                the duration of the connection while accessing the app, or other third party charges.
            ...
            <Typography paragraph>
                Along the same lines, Nikolay Vereshchagin cannot always take responsibility
                ...
                to avail the Service, Nikolay Vereshchagin cannot accept responsibility.
            </Typography>

            <Typography paragraph>
                With respect to Nikolay Vereshchagin’s responsibility for your use of the app,
                when you’re using the app, it’s important to bear in mind that although
                we endeavour to ensure that it is updated and correct at all times, we do
                rely on third parties to provide information to us so that we can make it
                available to you. Nikolay Vereshchagin accepts no liability for any loss,
                direct or indirect, you experience as a result of relying wholly on this functionality of the app.
            </Typography>
            ...
            <Typography paragraph>
                ...
                Nikolay Vereshchagin does not promise that it will always update the app so that it
                ...
                Unless we tell you otherwise, upon any termination, (a) the rights and licenses granted
                to you in these terms will end; (b) you must stop using the app,
            ...
            <Typography paragraph>
                ...
                do not hesitate to contact me at <Link href='mailto:nick.vereshchagin@gmail.com'>nick.vereshchagin@gmail.com</Link>.
            </Typography>
        </ContentBox>
    )
}

export default StankinScheduleTerms;
